...
import CouponGoodsItem from './course'
import CouponLiveGoodsItem from './course-live'
...
class GoodsItem extends Component {
  ...
  render() {
    ...
    // 好券直播
    if (type === 'course-live') return (<CouponLiveGoodsItem goods={goods} onClick={this.handleClick} />)
    // 好券清单
    if (type === 'course') return (<CouponGoodsItem goods={goods} onClick={this.handleClick} />)
    // 聚划算拼团
